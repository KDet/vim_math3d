...
namespace vim::math3d::mathOps {
    ...
    template <typename T>
    inline typename std::enable_if<std::is_arithmetic<T>::value, T>::type
        minimum(T v1, T v2) { return v1 < v2 ? v1 : v2; }

    template <typename T>
    inline typename std::enable_if<std::is_arithmetic<T>::value, T>::type
        maximum(T v1, T v2) { return v1 > v2 ? v1 : v2; }
    ...
    template <typename T>
    inline typename std::enable_if<std::is_arithmetic<T>::value, T>::type
       clampLower(T v, T min)  { return maximum(v, min); }

    template <typename T>
    inline typename std::enable_if<std::is_arithmetic<T>::value, T>::type
        clampUpper(T v, T max)  { return minimum(v, max); }

    template <typename T>
    inline typename std::enable_if<std::is_arithmetic<T>::value, T>::type
        clamp(T v, T min, T max)  { return maximum(minimum(v, max), min); }
