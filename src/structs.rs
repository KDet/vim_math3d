...
use vim_math3d_macro_derive::{Struct, AlmostEq, FromTuple, FloatHash, UnaryOps, VectorOps, IntervalOps};

#[derive(Debug, PartialEq, Struct, FromTuple, FloatHash)] //IntervalOps
