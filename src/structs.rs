...
use vim_math3d_macro_derive::{StructOps, VectorOps, IntervalOps};

#[derive(Debug, PartialEq, StructOps)] //IntervalOps
pub struct AABox<T: Float = f32> {
    pub min: Vector3::<T>,
    pub max: Vector3::<T>,
}

#[derive(Debug, PartialEq, StructOps)]
...
#[derive(Debug, PartialEq, StructOps, VectorOps)]
...
//     pub fn barycentric(self, v2 : & Self, v3 : & Self, u : T, v : T) -> Self
//     {
//         let v2_sub_self = v2 - self;
//         let v3_sub_self = v3 - self;
//        // let v3_sub_self_mul_v = v3_sub_self * v;
//         //let v3_sub_self_mul_u = v2_sub_self * u;
